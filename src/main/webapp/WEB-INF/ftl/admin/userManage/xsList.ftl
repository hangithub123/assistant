...
<div class="row">
	<div class="col-md-12">
		<!-- TODO LIST -->
		<div class="panel">
			<form id="form" name="form" action="${ctx }/xsxxb/xsList" method="post">
			<div class="panel-heading">
				<h3 class="panel-title"><b>学生信息列表</b></h3>
				<div class="right">
				...
				<table class="table table-bordered">
			      <tr>
			      	...
			      	<td style="width:25%;text-align: left;vertical-align: middle;">
			      		<input type="text" class="form-control" id="dlh" name="dlh" value="<#if xsxxb.dlh??>${xsxxb.dlh}</#if>"/>
			      	</td>
					<td style="width:8%;text-align: right;vertical-align: middle;">姓名：</td>
			      	...
			      	<td style="width:25%;text-align: left;vertical-align: middle;">    		
			      		<select class="form-control input-sm" name="sybz" id="sybz" value="<#if xsxxb.sybz??>${xsxxb.sybz}</#if>">
							<option></option>
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="###" onclick="doShowDialog('${ctx }/xsxxb/showXszl?dlh=${it.dlh}','showXszl','窗口','1200px','680px')"><i class="lnr lnr-pencil"></i> <span>详情</span></a>
							</td>
						</tr>
						</#list>
						</#if>
