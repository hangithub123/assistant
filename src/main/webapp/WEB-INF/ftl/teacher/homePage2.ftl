...
<@head>
	<script type="text/javascript">
		...
		$(function(){
			$("a[target=teacherMainWorkArea]").click(function(){
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${ctx}/course" target="teacherMainWorkArea" class=""><i class="lnr lnr-code"></i> <span>课程管理</span></a></li>
						<li><a href="${ctx}/courseApplication" target="teacherMainWorkArea" ><i class="lnr lnr-bookmark"></i> <span>学生管理</span></a></li>
						<li><a href="panels.html" target="teacherMainWorkArea" class=""><i class="lnr lnr-chart-bars"></i> <span>教学</span></a></li>
						<li><a href="notifications.html" target="teacherMainWorkArea" class=""><i class="lnr lnr-file-empty"></i> <span>作业收集</span></a></li>
						<li>
						...
						<li>
							...
							<div id="subPages1" class="collapse ">
								<ul class="nav">
									<li><a href="${ctx }/jsxxb/showjszl?dlh=${czyDlh}"  target="teacherMainWorkArea">个人资料</a></li>
									<li><a href="${ctx }/jsxxb/modifierJsxx"  target="teacherMainWorkArea">资料完善与修改</a></li>
									<li><a href="${ctx }/jxzgrz/modifierJxzgrz"  target="teacherMainWorkArea">资格认证</a></li>
								</ul>
							</div>
						</li>
					</ul>
...
$(function(){
	...
	$WorkAreaIframe.attr("height",height-120);
	$WorkAreaIframe.attr("width",width-300);
})
</script>
</@html>
